...
def train(curves, freqs):
    ...
    # Save model to file
    model.save('ddf_ext.h5')

curves, freqs = load_data()

#learning_rate_list = [0.0006, 0.0008, 0.001, 0.0012, 0.0014]  
#beta_list = [0.85, 0.9, 0.95, 0.99]
#for learning_rate in learning_rate_list:
#    for beta in beta_list:
train(curves, freqs)

#num_epochs_list = [270, 290, 310, 330, 350]
#for num_epochs in num_epochs_list:
#    train(curves, freqs, num_epochs)
